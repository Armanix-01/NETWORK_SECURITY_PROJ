...
class DataTransformation:
    def __init__(self, data_validataion_artifact:DataValidationArtifact,
        ...
        try:
            self.data_validation_artifact = data_validataion_artifact
    ...
    def get_data_transformer_object(cls):
        logging.info("entered the get_data_transformer_object of DataTransformer class")

        try:
            logging.info(f"initialising the KNNimputer with {training_pipeline.DATA_TRANSFORMATION_INPUTER_PARAMS}")
            imputer=KNNImputer(**training_pipeline.DATA_TRANSFORMATION_INPUTER_PARAMS)
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            save_object(file_path=self.data_transformation_config.transformed_object_dir, obj=preprocessor_obj)

            ##preparing return artifacts
