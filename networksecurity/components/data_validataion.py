    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            if status == False:
                ...
                invalid_train_path = self.data_validation_config.invalid_train_file_dir
                invalid_test_path = self.data_validation_config.invalid_test_file_dir
                train_df.to_csv(invalid_train_path,index=False, header=True
                )
                test_df.to_csv(
                    invalid_test_path, index=False, header=True

                )
            else:
                valid_train_path = self.data_validation_config.valid_train_file_dir
                valid_test_path = self.data_validation_config.valid_test_file_dir
                invalid_train_path = None
                invalid_test_path = None
                train_df.to_csv(
                    valid_train_path, index=False, header=True
                )
                test_df.to_csv(
                    valid_test_path, index=False, header=True
