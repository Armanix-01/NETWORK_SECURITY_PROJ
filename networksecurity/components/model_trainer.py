...
from networksecurity.entity.artifact_entity import ClassifactionMetricArtifact, ModelTrainerArtifact, DataTransformationArtifact
from networksecurity.utils.main_utils.utils import save_object,  load_obj, load_numpy_array_data, evaluate_models
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric:ClassifactionMetricArtifact):
    ...
    def train_model(self, x_train, y_train, x_test, y_test ):
        try:
            ...
            ##to get the best model score from model report(dict)
