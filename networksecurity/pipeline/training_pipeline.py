...
class TrainingPipeline:
    ...
    def start_data_validation(self, data_ingestion_artifact:DataIngestionArtifact):
        try:
            ...
            logging.info("Data validation startec")
    ...
    def start_model_trainer(self, data_transformation_artifact:DataTransformationArtifact):
        try:
            ...
            raise NetworkSecurityException(e, sys)
    ##My local artifact is goint in s3 bucker    
    def sync_artifact_dir_to_s3(self):
        try:
            aws_bucket_url = f"s3://{TRAINING_BUCKET_NAME}/artiface/{self.training_pipeline_config.timestamp}"
    ...
    ##My local final_model is going to s3 bucket
